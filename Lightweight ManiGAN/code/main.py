    ...
    with open(filepath, "r") as f:
        ...
        for name in filenames:
            ...
            for i in range(len(captions)):
                ...
                noise.append(Variable(torch.FloatTensor(1).normal_(0, 1)))
            key = name[(name.rfind('/') + 1):]
            data_dic[key] = [cap_array, cap_lens, sorted_indices, real_imgs, noise]
...
if __name__ == "__main__":
    ...
    if cfg.TRAIN.FLAG:
        ...
        if cfg.B_VALIDATION:
            ...
            gen_example(dataset.wordtoix, algo, imsize_list, image_transform, norm, data_dir) 
    end_t = time.time()
